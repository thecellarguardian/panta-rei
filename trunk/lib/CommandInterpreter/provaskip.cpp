...
namespace client
{
    ...
    struct employee_parser : qi::grammar<std::string::const_iterator, employee(), ascii::space_type>
    {
        ...
        qi::rule<std::string::const_iterator, employee(), ascii::space_type> start;
    };
    //]
}
...
main()
{
    ...
    typedef client::employee_parser employee_parser;
